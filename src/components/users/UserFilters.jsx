...
const UserFilters = memo(({ userCount, searchQuery, onSearchChange, filters, onFilterChange, onReset, onNewUser, availableRoles = [], canCreate = false, permLoading = false }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-up">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        ...
        {/* Bouton "Nouvel utilisateur" — visible seulement si droit Création */}
