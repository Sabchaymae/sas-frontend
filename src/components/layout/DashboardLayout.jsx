...
const DashboardLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Utilisateurs", href: "/dashboard/users", icon: <Users className="w-5 h-5" />, show: hasPermission('Utilisateurs', 'Lecture') },
    { name: "Rôles", href: "/dashboard/roles-permissions", icon: <Shield className="w-5 h-5" />, show: hasPermission('Autorisation', 'Lecture') },
    { name: "Historique", href: "/dashboard/historique", icon: <History className="w-5 h-5" />, show: true },
    { name: "Souscriptions", href: "/dashboard/subscriptions", icon: <CreditCard className="w-5 h-5" />, show: hasPermission('Souscriptions', 'Lecture') },
    { name: "Dossiers", href: "/dashboard/dossiers", icon: <Folder className="w-5 h-5" />, show: true },
    { name: "Stock", href: "/dashboard/stock", icon: <Box className="w-5 h-5" />, show: hasPermission('Stock', 'Lecture') },
    { name: "Communication", href: "/dashboard/communication", icon: <MessageSquare className="w-5 h-5" />, show: hasPermission('Communication', 'Lecture') },
    { name: "Tâches", href: "/dashboard/tasks", icon: <CheckSquare className="w-5 h-5" />, show: hasPermission('Tâches', 'Lecture') },
    { name: "Temps", href: "/dashboard/time", icon: <Clock className="w-5 h-5" />, show: hasPermission('Temps', 'Lecture') },
